...
const PropertiesScreen = observer(() => {
  ...
  const [filters, setFilters] = useState({
    ...
    property_type: '',
    purpose: params.type === 'Rent/PG' ? 'RENT' : params.type === 'Buy' ? 'SALE' : params.type === 'Commercial' ? 'BOTH' : '',
    min_price: '',
    max_price: '',
    bedrooms: '',
    agent_id: '',
  ...
  const handleSearch = useCallback(async (isLoadMoreArg = false) => {
    ...
    try {
      ...
      if (filters.purpose === 'SALE') queryParams.availability = 'sale';
      else if (filters.purpose === 'RENT') queryParams.availability = 'rent';
      else if (filters.purpose === 'BOTH') queryParams.availability = 'both';
            ...
            <View style={styles.listHeader}>
              ...
              >
                {[
                  ...
                  { name: 'Villa', value: 'Villa', icon: 'home-city-outline' },
