      ...
      <View style={styles.content}>
        ...
        <View style={styles.quickActionRow}>
          ...
          >
            ...
            <Text style={styles.quickActionLabel}>{isAgent ? 'Add Property' : 'Post Listing'}</Text>
          </TouchableOpacity>
          <TouchableOpacity 
        ...
        >
          ...
          <Text style={[styles.logoutBtnText, { color: themeColors.danger }]}>Sign Out of Account</Text>
        </TouchableOpacity>
